...
def search_keywords():
    if request.method == 'GET':
        ...
        page_indexer = 1
        while True:
            if s.search(keywords, 20, page_number=page_indexer):
                ...
                print("total pages: {}".format(page_indexer - 1))
                break
        ...
        return render_template("test.html", index_list=search_results, html=page_html_links)
